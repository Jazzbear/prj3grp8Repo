...
\GroupMemberNames[Tonni Nybo Follmann][Placeholder][Placeholder][Placeholder][Placeholder][Placeholder]{}
%add student numbers of the students, must have the exact same order as the names listed above.
\GroupMemberStudentNo[201504573][Placeholder][Placeholder][Placeholder][Placeholder][Placeholder]{}